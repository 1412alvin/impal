        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
             ...
             <form method="post" action="<?php echo base_url(). 'sepatu/editbarang'; ?>">

			 <tr>
				<div class="form-group">
					<td>Kode Barang</td>
					<td colspan="2"><input class = "form-control" type="text" name="kode" value="<?php echo $row->kode ?>" readonly></td>
				</div>
			</tr>
			<tr>
				<div class="form-group">
					<td>Merk</td>
					<td colspan="2"><input class = "form-control" type="text" name="merk" value="<?php echo $row->merk ?>" required></td>
				</div>
			</tr>
			 <tr>
				<div class="form-group">
					<td>Ukuran</td>
					<td colspan="2"><input class = "form-control" type="number" name="ukuran" value="<?php echo $row->ukuran ?>"required></td>
				</div>
			</tr>
			 <tr>
				<div class="form-group">
					<td>Jumlah</td>
					<td colspan="2"><input class = "form-control" type="number" name="jumlah" value="<?php echo $row->jumlah ?>"required></td>
				</div>
			</tr>
			 <tr>
				<div class="form-group">
					<td>Harga</td>
					<td colspan="2"><input class = "form-control" type="number" name="harga" value="<?php echo $row->harga ?>"required></td>
				</div>
			</tr>
			<tr>
				<td>&nbsp;</td>
				<td><input class ="btn btn-info" type="submit" value="Edit Data"><td>
			</tr>
			 </form>
           </table>
            </div>
