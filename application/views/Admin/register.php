...
<head>
  ...
  <title>Satya Sepatu - Registrasi</title>
            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <form class="user" method = "POST" action="<?php echo base_url(). 'Sepatu/tambahAkun'; ?>">
                  ...
                  <div class="text-center">
                    <a class="small" href="<?php echo base_url();?>Sepatu/login">Saya Sudah Punya Akun</a>
                  </div>
                </div>
              </div>
            </div>
